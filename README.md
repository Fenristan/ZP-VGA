...
Pokyny pro spuštění jsou následující:
 1. Pro spuštění na lokálním stroji se ujištěte, že na něm běží server.
...
a následně klikněte myší do vrcholu, ze kterého má hrana začínat a poté do druhého vrcholu, kde má hrana končit.
